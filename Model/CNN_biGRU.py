...
class CNN_biGRU(nn.Module):
    def __init__(self, vocab_size, word_emb_dim, word_embeddings, case_emb_dim, case_embeddings,
                 ...
                 gru_hidden_size, num_labels, dropout, dropout_recurrent, device):  
        ...
        self.fc = nn.Linear(2 * gru_hidden_size, num_labels)
    ...
    def forward(self, words, casing, chars):
        ...
        # BiGRU
        gru_out, _ = self.bigru(embeddings)  # [batch_size, seq_len, 2*gru_hidden_size]
        
        # Fully Connected
        fc_out = self.fc(gru_out)  # [batch_size, seq_len, num_labels]
